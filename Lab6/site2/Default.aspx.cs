...
public partial class _Default : System.Web.UI.Page
{
    ...
    // Scuba Bahama
    private static Package sb = new Package("Scuba Bahama", "A week-long cruise to Bahama with three day with three days of scuba diving. Those with prior experience may dive right in, while beginners should choose to take the optional, but very affordable lesson.", 1000m, new Extra[]{new Extra("SCUBA Instruction", 100m)});
